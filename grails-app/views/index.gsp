    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <ul>
                    <li> How to use BAIDU map ? &nbsp;&nbsp;<a href="/map/index?key=893557">go</a></li>
                    <li>Aren't logged in? <a href='/login'>login</a></li>
                    <li>Are you an administrator ? <a href='/admin/index'>go</a></li>
                    <li>Are you our customer ? <a href='/user/'>go</a></li>
                </ul>
            </div>
            <div class="col-md-4">
